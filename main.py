...
async def main():
    ...
    try:
        ...
        while True:
            ...
            asyncio.get_running_loop().create_task(file_service.write_to_file(f'sdr_data{sdr_sample_count}.txt', f"{time.time()},{sdr_service.center_freq}, {sdr_samples.to_list()}", overwrite=True))
